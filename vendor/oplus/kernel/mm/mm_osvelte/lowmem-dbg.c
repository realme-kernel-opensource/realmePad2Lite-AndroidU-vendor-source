...
void alloc_pages_slowpath_end_vh(void *data, gfp_t gfp_mask, unsigned int order, unsigned long delta)
{
...
int osvelte_lowmem_dbg_init(struct proc_dir_entry *root)
{
	...
	if (register_trace_android_vh_alloc_pages_slowpath_end(alloc_pages_slowpath_end_vh, NULL)) {
...
{
	unregister_trace_android_vh_alloc_pages_slowpath_end(alloc_pages_slowpath_end_vh, NULL);
	return 0;
}
